    ...
    <div class="panel">
        ...
        <div class="table-responsive">
            ...
            <v-table v-if="!editMode">
                ...
                <tbody>
                    <tr v-for="(detailVal, idx) in selectedRow.requiredDocuments" :key="detailVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">{{ detailVal.사용여부 }}</td>
                        <td class="whitespace-nowrap">
                            <FileType v-model="detailVal.fileType" :editMode="editMode"/>
                        </td>
                        <td class="whitespace-nowrap">
            ...
            <v-table v-else>
                ...
                <tbody>
                    <tr v-for="(addVal, idx) in newValue" :key="addVal" >
                        <td class="font-semibold">{{ idx + 1 }}</td>
                        <td class="whitespace-nowrap">
                            <Boolean style="margin-left: -5px; width: 150px;" :editMode="editMode" v-model="addVal.사용여부"/>
                        </td>
                        <td class="whitespace-nowrap">
                            <FileType v-model="addVal.fileType" :editMode="editMode"/>
                        </td>
                    </tr>
                </tbody>
            </v-table>
